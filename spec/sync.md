...
- **SYNC-BOOTSTRAP-1** — `scripts/sync` and the synced scripts `spec-check` and
  `ste-lint` must use core modules and `use v5.34` only. They run before any
  dependency install, and macOS ships perl 5.34.
